...
* motherOccupation only http://acsa.org/fhir/StructureDefinition/OccupationBackbone
* fatherOccupation 0..1 BackboneElement "Father's occupation details"
* fatherOccupation only http://acsa.org/fhir/StructureDefinition/OccupationBackbone
