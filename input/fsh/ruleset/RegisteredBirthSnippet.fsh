...
* subject 0..1	Reference(http://acsa.africa/fhir/StructureDefinition/Individual) "Subject that was born"
...
* birthNotification 0..1 Reference(http://acsa.africa/fhir/StructureDefinition/BirthNotification) "link toward the birth notification"
